...
def setup(doc=None, solvertype="ratel"):
    ...
    mat["Model"] = "elasticity-linear-damage"
    mat["YoungsModulus"] = "3.2 MPa"
    mat["PoissonRatio"] = "0.4"
    mat["nu_smoother"] = "0.39"
    mat["PoissonRatio"] = "0.4"
    mat["yield_stress"] = "0.1"
    mat["hardening_A"] = "0.1"
    mat["use_AT1"] = "true"
    mat["use_offdiagonal"] = "true"
    mat["fracture_toughness"] = "1"
    mat["characteristic_length"] = "0.3"
    mat["residual_stiffness"] = "1e-6"
    mat["damage_viscosity"] = "1"
